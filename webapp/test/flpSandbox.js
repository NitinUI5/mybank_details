		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comnm100mybankdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnm100mybankdetails-display": {
								"semanticObject": "comnm100mybankdetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nm100.mybankdetails",
									"url": sap.ui.require.toUrl("com/nm100/mybankdetails")
								}
							}
						}
					}
